# DELPHIN INC. — Website v1

A polished, responsive static website concept for Delphin Inc.
...
For the contact API locally: `vercel dev` (requires `RESEND_API_KEY` in `.env.local`).
# Delphin
